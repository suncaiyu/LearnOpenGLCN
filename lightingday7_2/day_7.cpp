...
void MainLoop()
{
    ...
    while (!glfwWindowShouldClose(mWindow))
    {
        ...
        ClearColor();
        float lightcolor[3] = {0.5f, 0.4f, 1.0f};
        // 被照射物体
        mShader->use();
        mShader->setVec3("objectColor", 1.0f, 0.5f, 0.31f);
        mShader->setVec3("lightColor",  lightcolor[0], lightcolor[1], lightcolor[2]);
        ...
        mLightingShader->setVec3("lightColor",  lightcolor[0], lightcolor[1], lightcolor[2]);
        model = glm::mat4(1.0f);
